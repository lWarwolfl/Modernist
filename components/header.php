<div class="nav-box flex row center">
    <a href="#" class="logo-box top flex row right">
    ...
    <div class="top-nav flex row center">
        ...
        <a class="top-nav-link" href="#story">Popular</a>
        <a class="top-nav-link" href="#story">Stories</a>
        <a class="top-nav-link" href="#team">Our team</a>
        <a class="top-nav-link" href="#contact">Contact us</a>
